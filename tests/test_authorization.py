...
from pages.auth_page import AuthPage, check_select_tab, check_forgot_pass
from test_data import valid_user1_email, valid_user1_pass, valid_user1_name, valid_user1_login, valid_user2_phone, \
    valid_user2_pass, valid_user2_name
...
def test_autochange_tabs(web_browser):
    ...
    try:
        page.tab_email.click()
        assert page.tab_email.is_active(check=check_select_tab, attr_name='class')
        page.input_login_field.send_keys('+79000926249')
        page.input_pass_field.click()
        assert page.tab_phone.is_active(check=check_select_tab, attr_name='class')
    except AssertionError as e:
